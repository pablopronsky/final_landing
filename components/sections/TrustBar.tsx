    ...
    >
      {TRUST_ITEMS.map((item, i) => (
        ...
        >
          ...
          <p className="text-hueso/55 font-normal text-[15px] leading-relaxed transition-[transform,color] duration-500 group-hover:translate-x-1 group-hover:text-hueso/80">{item.desc}</p>
